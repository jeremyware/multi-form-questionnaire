    ...
    <form action="includes/retailsubmit.inc.php" method="post" id="form-data">
     ...
     <div id="third">
      ...
      <fieldset id="primaryOwner">
       ...
       <div class="form-group">
        ...
        <input class="form-control" type="text" id="ownerSocial" placeholder="Social Security Number" name="owner-social" />
      ...
      <fieldset id="hiddenForm" style="display:none;">
       ...
       <div class="form-group">
        ...
        <input class="form-control" type="text" id="secondOwnerSocial" placeholder="ssn" name="secondary-owner-social" />
       </div>
       <div class="form-group">
     ...
     <div id="fourth">
      ...
      <div class="form-group">
       ...
       <br>
       <textarea type="text" class="form-control rounded-0" name="describe-product-info" cols="45" rows="5" id="productDescription" placeholder="Example" require></textarea>
      ...
      <div class="form-group">
       ...
       <!-- <a href="#" class="btn btn-danger" name="review" id="review">Next</a> -->
