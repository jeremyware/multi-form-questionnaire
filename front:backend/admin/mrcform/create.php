       ...
       <form action="create.php" method="post" id="form-data">
        <div id="mrcUPq1">
         ...
         <div class="form-group">
          ...
          <input class="form-control" type="text" name="mrcBusinessName" id="mrcBusinessName" required />
         </div>
         <div class="form-group">
          <label for="mrcBusinessStreet">Location Address</label>
          <input class="form-control" type="text" id="mrcBusinessStreet" placeholder="street address" name="mrcBusinessStreetAdd" />
         </div>
         <div class="form-group">
          <input class="form-control" type="text" id="mrcBusinessStreet2" placeholder="street address line 2" name="mrcBusinessStreetAdd2" />
         </div>
         <div class="form-group">
          <input class="form-control" type="text" id="mrcBusinessCity" placeholder="City" name="mrcBusinessCity" />
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
          <input class="form-control" type="text" id="mrcBusinessZip" placeholder="Zip Code" name="mrcBusinessZip" />
         </div>
         <div class="form-grop">
          <label for="mrcBusinessLegalName">Legal Business Name(as it appears on tax return)</label>
          <input class="form-control" type="text" name="mrcBusinessLegalName" id="mrcBusinessLegalName" />
         </div>
         <fieldset class="transaction-input-radio" name="rtlTransactionTypeField" id="transactionType">
          ...
          <div class="form-check">
           <input class="form-check-input" type="radio" name="mrcBusinessMailingRadio" id="productCardSwipe" value="Yes" />
           <label for="mrcBusinessMailingRadioY" class="form-check-label" for="flexRadioDefault1"> Yes </label>
          </div>
          <div class="form-check">
           <input class="form-check-input" type="radio" name="mrcBusinessMailingRadio" id="productMailTele" value="No" />
        ...
        <div id="mrcUPq3">
         ...
         <fieldset id="primaryOwner">
          ...
          <div class="form-group">
           ...
           <input class="form-control" type="text" id="mrcOwnerSocial" name="mrc-owner-social" placeholder="xxx-xx-xxxx" pattern="\d{3}-?\d{2}-?\d{4}">
          </div>
        ...
        <div id="mrcUPq10">
         ...
         <div class="col-12">
          ...
          <button class="btn btn-primary" type="add-form">Submit form</button>
         </div>
        </div>
      </div>
     </div>
