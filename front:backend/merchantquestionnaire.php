...
<div class="container bg-light p-3 mb-5 rounded">
    <div class="wrapper-container col-md-8 p-4 rounded mt-4 mb-5 bg-white rounded">

        <div class="mrc-form-navigation" id="rtlNavFn">
            <ul>
                <li id="rtlNaVBi">
                    <a href="#" class="btn btn-primary btn-lg">Business Info</a>
                </li>
                <li id="rtlNavBp">
                    <a href="#" class="btn btn-primary btn-lg">Business Profile</a>
                </li>
                <li id="rtlNavOi">
                    <a href="#" class="btn btn-primary btn-lg">Owner Information</a>
                </li>
                <li id="rtlNavPi">
                    <a href="#" class="btn btn-primary btn-lg">Product Info</a>
                </li>
                <li id="rtlNaVBi">
                    <a href="#" class="btn btn-primary btn-lg">Business Info</a>
                </li>
