 ...
 <div class="page-wrapper">
  ...
  <div class="post-slider">
   ...
   <div class="post-wrapper">
    ...
    <div class="post">
     <h4><a href="coachingForm.php">Coaching Questionnaire</a></h4>
    ...
    <div class="main-content">
     ...
     <div class="post clearfix">
      ...
      <table>
       ...
       <tbody>
        <?php foreach ($cchForms as $key => $cchForm) : ?>
         <tr>
          <td><?php echo $key + 1; ?></td>
          <td><?php echo $cchForm['cchBusinessName']; ?></td>
          <td><a href="edit.php?id=<?php echo $cchForm['id']; ?>" class="edit">edit</a></td>
          <td><a href="index.php?rev_id=<?php echo $cchForm['id']; ?>" class="delete">Review</a></td>
         </tr>
        <?php endforeach; ?>
