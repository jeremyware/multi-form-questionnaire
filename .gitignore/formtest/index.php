   ...
   <div class="col-md-6 bg-light p-4 rounded mt-5">
    ...
    <form action="" method="post" id="form-data">
     ...
     <div id="second">
      ...
      <div class="form-group">
       <label for="name">Business Structure</label>
      ...
      <fieldset class="form-group">
       <div class="form-group">
        <label class="radio-container">Corporation
         <input class="form-control" type="radio" name="radio" value="Corporation" id="businessCorp">
         <span class="checkmark"></span>
        </label>
       </div>
       <div class="form-group">
        <label class="radio-container"> LLC
         <input class="form-control" type="radio" name="radio" value="LLC" id="businessLlc">
         <span class="checkmark"></span>
        </label>
       </div>
       <div class="form-group">
        <label class="radio-container">Sole Propietor
         <input class="form-control" type="radio" name="radio" value="Sole Proprietor" id="businessProprietor">
         <span class="checkmark"></span>
        </label>
       </div>
       <div class="form-group">
        <label for="businessOther" class="radio-container">
         <input class="form-control" type="radio" name="radio" id="businessOther">
         <textarea type="text" placeholder="Other" id="businessOtherText"></textarea>
         <span class="checkmark"></span>
        </label>
       </div>
     ...
     <div id="fourth">
      ...
      <div class="form-group">
       ...
       <br>
       <textarea class="form-control rounded-0" name="describe-product-info" cols="29" rows="10" id="productDescription"></textarea>
      ...
      <fieldset class="transaction-input-radio" name="transactiontype" id="transactionType">
       ...
       <div class="form-group">
        <label for="productCardSwipe" class="product-radio-container"> Card Swipe
         <input class="form-control" type="radio" name="radio" value="Card Swipe" id="productCardSwipe">
         <span class="checkmark"></span>
        </label>
       ...
       <div class="form-group">
        <label for="productMailTelephone" class="product-radio-container"> Mail order/Telephone Order
         <input class="form-control" type="radio" name="radio" value="Mail order/Telephone order" id="productMailTelephone">
         <span class="checkmark"></span>
        </label>
       </div>
       ...
       <div class="form-group">
        <label for="productInternetEcommerce" class="product-radio-container">Internet/Ecommerce
         <input class="form-control" type="radio" name="radio" value="Internet/Ecommerce" id="productInternetEcommerce">
         <span class="checkmark"></span>
        </label>
       </div>
 ...
 <script>
  $(document).ready(function() {
   ...
   $("#submit").click(function(e) {
    ...
    // $("#productTransactionError").html('');


    if ($("#productDescription").val() == '') {
     $("#productDescriptionError").html('* Required Field.');
     return false;
    } else if ($("#productTransaction").val() == '') {
     $("#productTransactionError").html('* Required Field.');
     return false;
    } else {
     $.ajax({
      url: 'action.php',
